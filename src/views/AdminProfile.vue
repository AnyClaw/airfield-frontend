...
function goToPlaneForm() {
    router.push({name: 'PlaneForm'})
}
        ...
        <main class="main" v-if="!isLoading">
            <div class="profile">
                ...
                <div>
                    ...
                    <span class="status-pilot">АДМИН</span>
                    <ul class="profile-information">
                        <li>
                            <span>Логин:</span>
                            <span>{{ profile.login }}</span>
                        </li>
                        <button class="balance-button" @click="goToPlaneForm">Добавить самолёт</button>
                    </ul>
                </div>
            </div>
        </main>
